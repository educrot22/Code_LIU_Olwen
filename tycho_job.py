...
def mcmc(lamb, P, R_star, M_star, time_transit, R_planet, T_star, T_planet, uu):
        ...
        plt.savefig(f"priors_LHS3844b_{str(lamb)}.svg")
        ...
        plt.savefig(f"posteriors_LHS3844b_{str(lamb)}.svg")
        ...
        np.savetxt(f"result_mcmc_LHS3844b_{lamb}.txt", data, fmt="%.2f", delimiter="\t", header="16th percentile\t84th percentile\t50th percentile")
